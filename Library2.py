...
class menu:
   ...
   #     self.root.state('zoomed')
        ...
        conn.execute('''create table if not exists student_info
               ...
               PHNO VARTEXT NOT NULL,
               DEPT VARTEXT NOT NULL,
               EMAIL VARINT NOT NULL);''')
        conn.commit()
        #__________________________________________________________
...
# _____________________________________________________________________________________________________________________________________________________
    def addStudent(self):
        ...
        self.f1 = Frame(self.a, height=500, width=650, bg='black')
        self.f1.place(x=500, y=100)
        l1 = Label(self.f1, text='Student ID : ', font='Papyrus 12 bold', fg='Orange', bg='Black', pady=1).place(x=50,
                                                                                                              y=50)
        e1 = Entry(self.f1, width=45, bg='orange', fg='black', textvariable=self.aid).place(x=150, y=50)
        l2 = Label(self.f1, text='Name : ', font='Papyrus 12 bold', fg='Orange', bg='Black', pady=1).place(x=50,
                                                                                                            y=100)
        e2 = Entry(self.f1, width=45, bg='orange', fg='black', textvariable=self.name).place(x=150, y=100)
        l3 = Label(self.f1, text='Phone No : ', font='Papyrus 12 bold', fg='orange', bg='Black', pady=1).place(x=50,
                                                                                                             y=150)
        e3 = Entry(self.f1, width=45, bg='orange', fg='black', textvariable=self.phno).place(x=150, y=150)
        l4 = Label(self.f1, text='Department: ', font='Papyrus 12 bold', fg='orange', bg='Black', pady=1).place(x=50,
                                                                                                            y=200)
        e4 = Entry(self.f1, width=45, bg='orange', fg='black', textvariable=self.dept).place(x=150, y=200)
        l5 = Label(self.f1, text='Email : ', font='Papyrus 12 bold', fg='orange', bg='Black', pady=1).place(x=50,
                                                                                                             y=250)

        e5 = Entry(self.f1, width=45, bg='orange', fg='black', textvariable=self.email).place(x=150, y=250)

        b1 = Button(self.f1, text='Add', font='Papyrus 10 bold', fg='black', bg='orange', width=15, bd=3,
                    command=self.adddata2).place(x=150, y=400)
        b2 = Button(self.f1, text='Back', font='Papyrus 10 bold', fg='black', bg='orange', width=15, bd=3,
                    command=self.rm2).place(x=350, y=400)
    def adddata2(self):
        a = self.aid.get()
        b = self.name.get()
        c = self.phno.get()
        ...
        try:
            if (a and b and c and d ) == "":
                ...
                conn.execute("insert into student_info \
                    values (?,?,?,?,?)",
    ...
    def student(self):
        ...
        l5 = Button(self.a, text='Add Student', font='Papyrus 22 bold', fg='Orange', bg='Black', width=15, padx=10,command=self.addStudent).place(x=12, y=400)
